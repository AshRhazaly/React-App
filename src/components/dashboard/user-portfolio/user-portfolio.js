...
const UserPortfolio = ({ currencyExposureData, assetAllocationData }) => {
  return (
    <section className="user-portfolio-card card p-5 shadow p-3 mb-5 bg-white rounded">
      ...
      <section className="card-body pt-5">
        <CurrencyExposure currencyExposure={currencyExposureData}/>
        <AssetAllocation assetAllocation={assetAllocationData}/>
      </section>
    </section>
  );
};
